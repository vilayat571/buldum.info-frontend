      ...
      >
        <div className="xl:w-1/3  lg:w-1/3 md:w-1/3  sm:w-11/12   h-[340px] flex flex-col items-center">
          ...
          <p className="mt-3 px-2 text-[#000] relative text-left w-full ">
            <span className="text-[#DC2625]">Diqqət:</span> Daxil etdiyiniz kodu
            5 rəqəmli olmalılıdır, kodun yalnız rəqəmlərdən ibarət olmalıdır.
            Kodun doğruluğundan əmin olun əks halda daxil etdiyiniz koda uyğun
            elan tapılmayacaqdır.
          </p>
